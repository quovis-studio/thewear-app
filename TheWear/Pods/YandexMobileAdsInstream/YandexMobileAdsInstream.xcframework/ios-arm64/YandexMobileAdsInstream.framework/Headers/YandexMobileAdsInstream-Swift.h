...
/// Notifies about error occurred during instream ad playback.
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
/// Notifies about error occurred during instream ad break playback.
...
SWIFT_PROTOCOL_NAMED("InstreamCustomClickConnector") SWIFT_DEPRECATED_MSG("InstreamCustomClickConnector will be removed in future versions.")
...
SWIFT_PROTOCOL_NAMED("InstreamCustomClickHandler") SWIFT_DEPRECATED_MSG("InstreamCustomClickHandler will be removed in future versions.")
...
SWIFT_PROTOCOL_NAMED("InstreamCustomClickable") SWIFT_DEPRECATED_MSG("InstreamCustomClickable will be removed in future versions.")
...
@interface YMAInstreamVideoAd (SWIFT_EXTENSION(YandexMobileAdsInstream))
...
@property (nonatomic, readonly, copy) NSString * _Nullable apiFramework;
@end
...
/// Sets ad break types that are non-skippable.
/// \param adBreakTypes A set of strings representing the ad break types to be
/// non-skippable. See allowed values in <code>InstreamAdBreakType</code> class.
///
+ (void)setNonSkippableAdBreakTypes:(NSSet<NSString *> * _Nonnull)adBreakTypes;
/// Indicates whether the ad is muted at the start.
/// \param isMuted If set to <code>true</code>, the ad will start playing with muted sound, otherwise, it will be unmuted. Default value is <code>true</code>.
///
...
@protocol YMAVideoAdInfo;
/// Provides information about video ad.
SWIFT_PROTOCOL_NAMED("VideoAd")
@protocol YMAVideoAd
/// Describes a recommended media file for an ad.
@property (nonatomic, readonly, strong) id <YMAMediaFile> _Nonnull mediaFile;
/// Describes all possible media files for an ad.
@property (nonatomic, readonly, copy) NSArray<id <YMAMediaFile>> * _Nonnull mediaFiles;
/// Describes amount and current position of ad in ad pod.
...
@property (nonatomic, readonly, copy) NSString * _Nullable adInfo SWIFT_DEPRECATED_MSG("Use info.extensionInfo instead.");
/// Describes information about an ad.
@property (nonatomic, readonly, strong) id <YMAVideoAdInfo> _Nonnull info;
@end

@protocol YMAVideoAdtuneInfo;
/// Describes information about an instream ad.
SWIFT_PROTOCOL_NAMED("VideoAdInfo")
@protocol YMAVideoAdInfo
/// Instream ad identifier.
...
/// Describes information about extensions.
@property (nonatomic, readonly, copy) NSString * _Nullable extensionInfo;
/// Describes information about advertiser.
@property (nonatomic, readonly, copy) NSString * _Nullable advertiserInfo;
/// Describes information for custom ad tune.
@property (nonatomic, readonly, strong) id <YMAVideoAdtuneInfo> _Nullable adTuneInfo;
@end

/// Describes information for custom Ad Tune action.
SWIFT_PROTOCOL_NAMED("VideoAdTuneInfo")
@protocol YMAVideoAdtuneInfo
/// Provides information from ‘adChoices’.
@property (nonatomic, readonly, copy) NSDictionary * _Nullable adChoices;
/// Provides token for ad tune.
